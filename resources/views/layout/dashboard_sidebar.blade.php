			  ...
			  <ul data-submenu-title="Start">
							...
							<li ><a href="{{url('see_notification_entrepreneur')}}"><i class="icon-material-outline-question-answer"></i> Notificaton </a></li>

							<li ><a href="{{url('manage_hire')}}"><i class="icon-material-outline-question-answer"></i> Manage Hire </a></li>
							<li ><a href="{{url('user_blog_category')}}"><i class="icon-material-outline-question-answer"></i> My Blog </a></li>
				...
				<ul data-submenu-title="Start">
							<li><a href="{{url('dashboard')}}"><i class="icon-material-outline-dashboard"></i> Dashboard</a></li>
							<!-- <li ><a href="dashboard-messages.html"><i class="icon-material-outline-question-answer"></i> Messages <span class="nav-tag">2</span></a></li> -->
							<li ><a href="{{url('see_notification_entrepreneur')}}"><i class="icon-material-outline-question-answer"></i> Notificaton </span></a></li>
