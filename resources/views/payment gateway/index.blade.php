...
<!-- Mirrored from p.w3layouts.com/demos/payment_form_widget/web/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Nov 2020 12:30:40 GMT -->
...
<!-- //for-mobile-apps -->
<link href="{{asset('assets')}}/payment_gateway/css/style.css" rel="stylesheet" type="text/css" media="all" />
...
<script type="text/javascript" src="{{asset('assets')}}/payment_gateway/js/jquery.min.js"></script>
</head>
<body>
...
<body><link rel="stylesheet" href="{{asset('assets')}}/payment_gatewayimages/demobar_w3_4thDec2019.css">
	<!-- Demo bar start -->
	...
	<div class="main">
		...
		<div class="content">
			...
			<script src="{{asset('assets')}}/payment_gateway/js/easyResponsiveTabs.js" type="text/javascript"></script>
...
<!-- Mirrored from p.w3layouts.com/demos/payment_form_widget/web/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Nov 2020 12:30:47 GMT -->
</html>