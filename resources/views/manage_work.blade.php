									...
									<div class="freelancer-overview manage-candidates">
										<div class="freelancer-overview-inner">
											...
											<div class="freelancer-name">
												...
												<h4>Entreprenure name : <a href="#" style="color:blue">{{$hire->hire_from_name}} </a></h4>
												<h4>Price : <a href="#" style="color:blue">{{$hire->proposed_hired_budget}} tk </a></h4>  

											
												
												<span class="freelancer-detail-item"><i class="icon-feather-phone"></i>{{$hire->hire_from_mobile_number}} </span>
