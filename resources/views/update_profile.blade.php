									...
									<div class="col-xl-4">
										<div class="submit-field">
											<div class="bidding-widget">
												...
												<!-- Slider -->
												<div class="bidding-value margin-bottom-10">BDT<span id="biddingVal"></span></div>
												<input class="bidding-slider" type="text" value="" data-slider-handle="custom" data-slider-currency="$" data-slider-min="200" data-slider-max="1000" data-slider-value="35" data-slider-step="1" data-slider-tooltip="hide" />
											</div>
										</div>
									</div>
										...
										<div class="submit-field">
											...
											<div class="keywords-container">
												<div class="keyword-input-container">
													<input type="text" class="keyword-input with-border" placeholder="Scrabook"/>
